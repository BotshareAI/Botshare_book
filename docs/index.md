...
## Our solution  
This initiative comprised of two parts: **[Level_1: Incubation](../docs/L1_Incubation.md)** and **[Level_2 Acceleraion](../docs/L2_Acceleration.md)**. First part is a set of PVC educational DIY kits and second part is based on **two open-source real-world projects** that merge **AI-driven automation with practical robotics training**:  
