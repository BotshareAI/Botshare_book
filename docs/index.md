...
## Our solution  
This initiative comprised of two parts: **[Level_1: Incubation](../L1_Incubation.md)** and **[Level_2 Acceleraion](../L2_Acceleration.md)**. First part is a set of PVC educational DIY kits and second part is based on **two open-source real-world projects** that merge **AI-driven automation with practical robotics training**:  
